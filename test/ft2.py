...
class put_chinese_text(object):
    ...
    def getTextSize(self,text,text_size):
        ...
        for cur_char in text:
            ...
            size[0] += slot.bitmap.width
            if cur_char == ' ':
                size[0] += text_size
            size[1] = max(size[1],slot.bitmap.rows)
        return size
...
if __name__ == '__main__':
    ...
    ft = put_chinese_text('simsun.ttc')
